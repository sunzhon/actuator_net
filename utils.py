...
def train_actuator_network(xs, ys, actuator_network_path,epochs=100):

    print("model input dim: {} and output dim: {}".format( xs.shape, ys.shape))
...
def train_actuator_network_and_plot_predictions(log_dir_root, log_dir, actuator_network_path, load_pretrained_model=False):
    ...
    if load_pretrained_model:
        ...
        model = train_actuator_network(xs, ys, actuator_network_path, epochs=1000).to("cpu")
